(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e=`modulepreload`,t=function(e){return`/front_6th_chapter1-1/`+e},n={},r=function(r,i,a){let o=Promise.resolve();if(i&&i.length>0){let r=document.getElementsByTagName(`link`),s=document.querySelector(`meta[property=csp-nonce]`),c=s?.nonce||s?.getAttribute(`nonce`);function l(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}o=l(i.map(i=>{if(i=t(i,a),i in n)return;n[i]=!0;let o=i.endsWith(`.css`),s=o?`[rel="stylesheet"]`:``,l=!!a;if(l)for(let e=r.length-1;e>=0;e--){let t=r[e];if(t.href===i&&(!o||t.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${i}"]${s}`))return;let u=document.createElement(`link`);if(u.rel=o?`stylesheet`:e,o||(u.as=`script`),u.crossOrigin=``,u.href=i,c&&u.setAttribute(`nonce`,c),document.head.appendChild(u),o)return new Promise((e,t)=>{u.addEventListener(`load`,e),u.addEventListener(`error`,()=>t(Error(`Unable to preload CSS for ${i}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(e=>{for(let t of e||[]){if(t.status!==`rejected`)continue;s(t.reason)}return r().catch(s)})};async function i(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);return await c.json()}async function a(e){let t=await fetch(`/api/products/${e}`);return await t.json()}async function o(){let e=await fetch(`/api/categories`);return await e.json()}function s({product:e}){return`
  ...
  `);function ce(){let e=$(),t=()=>{let t=document.querySelector(`.go-to-product-list`);t&&t.addEventListener(`click`,()=>{e.navigate(`/`)})},n=async(e={})=>{let{id:n}=e;J=await ie(n),oe(J),t()},r=()=>`
    ...
    `,i=()=>{J=null};return{setup:n,cleanup:i,setupEvent:t,render:r}}var Z=ce;const Q=`/front_6th_chapter1-1`,$=()=>{let e={"/":q,"/product/:id":Z};function t(t,n){e[t]=n}let n=e=>RegExp(`^`+e.replace(/\//g,`\\/`).replace(/:\w+/g,`(.+)`)+`$`),r=t=>{if(e[t])return{component:e[t],params:{}};for(let[r,i]of Object.entries(e))if(r.includes(`:`)){let e=n(r),a=t.match(e);if(a){let e=r.match(/:\w+/g)?.map(e=>e.slice(1))||[],t={};return e.forEach((e,n)=>{t[e]=a[n+1]}),console.log(t,i),{component:i,params:t}}}return{component:e[`/`],params:{}}},i=e=>e.startsWith(Q)?e.slice(21)||`/`:e,a=e=>Q+e;function o(e){let t=a(e);window.history.pushState({},``,t);let{component:n,params:i}=r(e),o;o=typeof n==`function`&&!n.render?n():n,document.getElementById(`root`).innerHTML=o.render(i),o.setup&&o.setup(i)}function s(){window.addEventListener(`popstate`,()=>{let e=i(window.location.pathname);o(e)});let e=i(window.location.pathname);o(e)}return{addRoute:t,init:s,navigate:o}},le=()=>r(async()=>{let{worker:e,workOptions:t}=await import(`./browser-vWTd4VZR.js`);return{worker:e,workOptions:t}},[]).then(({worker:e,workOptions:t})=>e.start(t));function ue(){let e=$();window.router=e,e.init()}le().then(ue);